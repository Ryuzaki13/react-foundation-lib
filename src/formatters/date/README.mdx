...
<Meta title="Foundation Lib/API/Formatters/Date" />
...
Для одинакового отображения абсолютной метки времени на SSR-сервере и в браузере
используйте явный часовой пояс IANA:

```ts
formatInstantDateTime("2026-09-04T10:22:28Z", {
	timeZone: "Asia/Yekaterinburg"
}); // "4 сент. 2026 г., 15:22:28"
```
...
| Universal format | `formatDate`, `formatDateRange`, `formatInstantDateTime`                                                                                                                                                                                                                                                                                                                          |
