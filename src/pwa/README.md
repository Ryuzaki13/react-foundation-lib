...
```js
importScripts("/sap/bc/ui5_ui5/sap/ZARM_APP/sw.js?t=<cache_token>");
```
...
```html
<link rel="manifest" href="/sap/bc/ui5_ui5/sap/ZARM_APP/pwa/manifest.<appId>.json" />
```
