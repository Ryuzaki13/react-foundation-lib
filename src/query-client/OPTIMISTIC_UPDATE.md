	...
	return useMutation({
		mutationFn: (tile: SettingTileData) =>
			fetchJsonMutationFn<void, RawSettingTileMutationData>(
				`/${SERVICE}/TextTileSet(ID_SCAN='${tile.scanId}',ID='${tile.id}')`,
				"PUT",
				"odata"
...
export const useCreateTaskMutation = () => {
	...
	return useMutation({
		mutationFn: (data: NewTask) => fetchJsonMutationFn<Task, NewTask>("/TextTaskSet", "POST", "odata")(data),
...
export const useUpdateOrderStatusMutation = () => {
	...
	return useMutation({
		mutationFn: (data: UpdateOrderStatus) =>
			fetchJsonMutationFn<void, UpdateOrderStatus>(`/TextOrderSet('${data.id}')`, "PATCH", "odata")(data),
